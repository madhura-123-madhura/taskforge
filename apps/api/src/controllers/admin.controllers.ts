import { CREATE_TASK_REQUEST, CREATE_TASK_RESPONSE, DELETE_EMPLOYEE_REQUEST, DELETE_EMPLOYEE_RESPONSE, DELETE_TASK_DETAILS_REQUEST, DELETE_TASK_DETAILS_RESPONCE, FETCH_TASK_REQUEST, FETCH_TASK_RESPONSE, ME_REQUEST, ME_RESPONSE, READ_EMPLOYEE_REQUEST, READ_EMPLOYEE_RESPONSE, REGISTER_EMPLOYEE_REQUEST, REGISTER_EMPLOYEE_RESPONSE, RESTORE_EMPLOYEE_REQUEST, RESTORE_EMPLOYEE_RESPONSE, UPDATE_EMPLOYEE_REQUEST, UPDATE_EMPLOYEE_RESPONSE, UPDATE_PROFILE_REQUEST, UPDATE_PROFILE_RESPONSE, UPDATE_TASK_DETAILS_REQUEST, UPDATE_TASK_DETAILS_RESPONSE, UPDATE_TASK_REQUEST, UPDATE_TASK_RESPONSE } from "@repo/types"
...
import { registerTemplet } from "../email-templets/registerTemplet"
...
export const registerEmployee = async (req: Request<{}, {}, REGISTER_EMPLOYEE_REQUEST>, res: Response<REGISTER_EMPLOYEE_RESPONSE>) => {
    try {
        ...
        adminProfileUpload(mreq, res, async err => {
            ...
            const { email, mobile, name } = mreq.body
            ...
            await sendEmail({
                ...
                message: registerTemplet({ name: mreq.body.name, password: pass })
            })
...
export const updateTaskDetails = async (req: Request<{ tid: number }, {}, UPDATE_TASK_DETAILS_REQUEST>, res: Response<UPDATE_TASK_DETAILS_RESPONSE>) => {
    try {
        ...
        taskHeroUpload(mreq, res, async err => {
            if (err) {
                return res.status(400).json({ message: "unabel to upload image" })
            }
...
export const deleteTaskDetails = async (req: Request<{ tid: number }, {}, DELETE_TASK_DETAILS_REQUEST>, res: Response<DELETE_TASK_DETAILS_RESPONCE>) => {
    try {
