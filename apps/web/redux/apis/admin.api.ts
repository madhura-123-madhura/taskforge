    ...
    endpoints: (builder) => {
        return {
            ...
            updateTaskDetails: builder.mutation<UPDATE_TASK_DETAILS_RESPONSE, { id: number, fd: FormData }>({
                query: taskData => {
                    return {
                        url: "/task-detail-update/" + taskData.id,
                        method: "PUT",
                        body: taskData.fd
                    }
                },
            ...
            deleteTaskDetails: builder.mutation<DELETE_TASK_DETAILS_RESPONCE, DELETE_TASK_DETAILS_REQUEST>({
                query: taskData => {
                    return {
                        url: "/task-detail-delete/" + taskData.id,
                        method: "DELETE",
